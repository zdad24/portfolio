...
const PROJECTS = [
  ...
  },
  {
    name: 'MemoMuse',
    file: 'memomuse.py',
    blurb: 'Turns voice memos into produced tracks via a 6-stage async FastAPI pipeline — Whisper → Gemini → Lyria. Also ships a Voicemail Copilot for Shopify merchants: Gemini triages urgency, ElevenLabs replies.',
    impact: 'Winner @ ListenHacks · 6-stage async pipeline',
    tech: ['Python', 'FastAPI', 'Gemini', 'ElevenLabs', 'Google Lyria'],
    github: 'https://github.com/Maristanez/MemoMuse',
    demo: null,
    comingSoon: true,
    art: 'music',
  },
  ...
  },
  {
    ...
    tech: ['Next.js', 'FastAPI', 'XGBoost', 'PostgreSQL', 'GTFS'],
    github: null,
